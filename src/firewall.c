...
int main(int argc, char **argv) {
	...
	threads = create_consumers(thread_ids, num_consumers, &ring_buffer, argv[2], &sort_thread, &list);
	...
	consumed_packets_list_print(&list, out_fd);
	consumed_packets_list_destroy(&list);
